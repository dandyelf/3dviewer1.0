...
public:
    ...
    void setupUi(QMainWindow *viewer)
    {
        ...
        pushButton_ScaleX->setObjectName("pushButton_ScaleX");
        ...
        pushButton_ScaleY->setObjectName("pushButton_ScaleY");
        ...
        pushButton_ScaleZ->setObjectName("pushButton_ScaleZ");
        ...
        pushButton_TurnX->setObjectName("pushButton_TurnX");
        ...
        pushButton_TurnY->setObjectName("pushButton_TurnY");
        ...
        pushButton_TurnZ->setObjectName("pushButton_TurnZ");
        ...
        pushButton_Turn->setObjectName("pushButton_Turn");
        ...
        lineEdit_Zneg->setObjectName("lineEdit_Zneg");

        gridLayout_2->addWidget(lineEdit_Zneg, 1, 3, 1, 1);

        pushButton_Zneg = new QPushButton(groupBox_2);
        pushButton_Zneg->setObjectName("pushButton_Zneg");
        ...
        lineEdit_Zpos->setObjectName("lineEdit_Zpos");
        ...
        pushButton_Zpos->setObjectName("pushButton_Zpos");
